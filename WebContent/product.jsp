...
<html:form styleId="productForm" styleClass="rounded" action="AddProduct.do" >
<h3>Add Product Form</h3>

<div class="field">
	<label for="productID">Product Id:</label>
  	<html:text styleClass="input" property="productId" />
	<p class="hint">Enter Product Id.</p>
</div>

<div class="field">
	<label for="productName">Product Name:</label>
  	<html:text styleClass="input" property="productName" />
	<p class="hint">Enter Product Name.</p>
</div>

<div class="field">
	<label for="stock">Stock:</label>
  	<html:text styleClass="input" property="stock" />
	<p class="hint">Enter the Initial Stock Count.</p>
</div>

<div class="field">
	<label for="weight">Weight:</label>
	<html:text styleClass="input" property="weight" />
