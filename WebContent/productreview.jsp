...
<html:form styleId="productReviewForm" styleClass="rounded" action="AddProductReview.do" >
...
<div class="field">
	<label for="reviewTitle">Review Title:</label>
  	<html:text styleClass="input" property="reviewTitle" />
	<p class="hint">Enter the Review Title.</p>
</div>

<div class="field">
	<label for="reviewText">Review Text:</label>
	<html:text styleClass="input" property="reviewText" />
	<p class="hint">Enter the Review Text.</p>
</div>

<div class="field">
	<label for="rating">Rating:</label>
	<html:text styleClass="input" property="rating" />
	<p class="hint">Enter the Rating.</p>
</div>
